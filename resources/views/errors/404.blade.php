...
<head>
    ...
    <title>بنك الاستقلال للاستثمار والتنمية | حدث خطأ</title>
    <meta name="description" content="بنك الاستقلال للاستثمار والتنمية - بوابة الدخول لبنك الاستقلال للاستثمار والتنمية" />
    <!-- Favicon Tags Start -->
            ...
            <div class="offset-0 col-12 d-none d-lg-flex offset-md-1 col-lg h-lg-100">
                <div class="min-h-100 d-flex align-items-center">
                    <div class="w-100 w-lg-75 w-xxl-50">
                        <div>
                            <div class="mb-5">
                                <h1 class="display-3 fw-bold text-white">لحياة أفضل</h1>
                            </div>
                            <p class="h4 text-white lh-lg mb-5">
                                بنك الاستقلال للاستثمار والتنمية يعمل وفق أفضل الممارسات وبالشراكة مع المؤسسات والهيئات الرسمية والصناديق الحكومية والقطاع الخاص الحكومية، بما يسرع عملية التنمية الاجتماعية والاقتصادية في فلسطين
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-10 offset-0 offset-md-1  offset-lg-0 col-lg-auto h-100 pb-4 px-sm-4 pt-0 p-lg-0">
                <div class="sw-lg-70 min-h-100 bg-foreground d-flex justify-content-center align-items-center shadow-deep py-5 px-5 px-sm-0 full-page-content-left-border">
                    <div class="sw-lg-50 px-md-5">
                        ...
                        <div class="mb-5">
                            <h2 class="cta-1 mb-0 text-primary">لقد حدث خطأ ما!</h2>
                            <h2 class="display-2 text-primary">خطأ 404</h2>
                        </div>
                        <div class="mb-5">
                            <p class="h6">يبدو أن الصفحة التي تبحث عنها غير متوفرة.</p>
                        </div>
                        <div>
                            <a href="{{route('portal.login')}}" class="btn btn-icon btn-icon-start btn-secondary">

...
{{--                    <p class="h5">لتحقق من--}}
{{--                        <a href="{{asset('user_manual/story.html')}}" target="_blank" class="fw-bold text-secondary">دليل المستخدم</a>--}}
{{--                        .--}}
{{--                    </p>--}}
                </div>
                <div>
                    ...
                    <form id="login-form" action="{{route('portal.login.submit')}}" method="post" class="tooltip-end-bottom d-none" novalidate>
                        ...
                        <div class="mb-3 filled form-group tooltip-end-top">
                            <a class="mt-3 d-block" id="forget_password" href="{{route('portal.password.forget')}}">نسيت كلمة المرور؟</a>
                        </div>
                ...
                <div class="text-center mt-4">
                    <p class="h5 mb-3">يمكنك الاطلاع على دليل المستخدم</p>
                    <a href="{{asset('user_manual/story.html')}}" target="_blank" title="دليل المستخدم">
                        <img src="{{asset('assets/img/user_manual_img.png')}}" alt="" width="100px">
                    </a>
                </div>
            </div>
                ...
                success: function (response) {
                    if(response.status){
                        if(response.data['MODULE_ID'] == 1){
                            ...
                            $('#forget_password').attr('href', '{{route('portal.password.forget.by')}}');

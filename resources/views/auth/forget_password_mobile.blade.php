                ...
                <div class="wizard" id="wizardValidation">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="validationSecond" role="tabpanel">
                            <p class="card-text text-alternate mb-4 mt-4 fs-6">تم إرسال رمز تحقق برسالة نصية إلى الهاتف المحمول <span class="text-secondary fw-bold" id="full_number" dir="ltr"></span> يرجى إدخال الرمز للتأكيد</p>

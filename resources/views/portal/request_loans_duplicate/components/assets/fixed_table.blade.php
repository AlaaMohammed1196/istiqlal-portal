<div class="table-responsive">
    <table class="table align-middle">
        ...
        <tbody>
        @php $current_assets = collect($constants['FUND_FINANCIAL_INFORMATION'])->where('FINANCIAL_INFO_TYPE_ID', 1)->where('FINANCIAL_INFO_SUB_TYPE_ID', 2) @endphp
        @php $fs_sub_sum = 0; $fs_year_sum = 0; @endphp
        @foreach($current_assets as $item)
            ...
            @endphp<tr id="info-{{$item['FINANCIAL_INFO_ID']}}">
                ...
                <td  class="text-center" width="15%">
                    ...
                    <button class="btn btn-sm btn-icon btn-icon-only btn-outline-dark align-top mx-2 row-edit-btn" data-type="1" onclick="edit_row(this);" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </button>
                    <button class="btn btn-sm btn-icon btn-icon-only btn-outline-success align-top mx-2 d-none row-save-btn" type="button" data-bs-toggle="dropdown" aria-expanded="false" aria-haspopup="true">
        ...
        <tr class="table-light">
            ...
            <td class="text-center table-light"><input class="form-control table-input sub text-center" disabled value="{{$fs_sub_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input year text-center" disabled value="{{$fs_year_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input diff text-center" disabled value="{{$fs_year_sum - $fs_sub_sum}}"></td>

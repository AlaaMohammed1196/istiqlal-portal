<div class="table-responsive">
    <table class="table align-middle">
        ...
        <tbody>
        @php $current_assets = collect($constants['FUND_FINANCIAL_INFORMATION'])->where('FINANCIAL_INFO_TYPE_ID', 2)->where('FINANCIAL_INFO_SUB_TYPE_ID', 4) @endphp
        @php $fl_sub_sum = 0; $fl_year_sum = 0; @endphp
        ...
        @endforeach
        <tr class="table-light total-fixed">
            <th scope="row" class="table-light">المجموع</th>
            <td class="text-center table-light"><input class="form-control table-input sub text-center" readonly value="{{$fl_sub_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input year text-center" readonly value="{{$fl_year_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input diff text-center" readonly value="{{$fl_year_sum-$fl_sub_sum}}"></td>
            <td  class="text-center table-light" width="15%"></td>
        </tr>
        <tr class="bg-primary">
            <th scope="row" class="bg-primary text-white">مجموع المطلوبات</th>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_sub_1 text-center" readonly value=""></td>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_year_1 text-center" readonly value=""></td>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_diff_1 text-center" readonly value=""></td>

<div class="table-responsive">
    <table class="table align-middle">
        ...
        <tr class="table-light total-fixed">
            ...
            <td class="text-center table-light"><input class="form-control table-input sub text-center" readonly value="0"></td>
            <td class="text-center table-light"><input class="form-control table-input year text-center" readonly value="0"></td>
            <td class="text-center table-light"><input class="form-control table-input diff text-center" readonly value="0"></td>
            <td  class="text-center table-light" width="15%"></td>
        </tr>
        <tr class="bg-primary">
            <th scope="row" class="bg-primary text-white">مجموع المطلوبات</th>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_sub_1 text-center" readonly value="0"></td>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_year_1 text-center" readonly value="0"></td>
            <td class="text-center bg-primary"><input class="form-control table-input text-white total_diff_1 text-center" readonly value="0"></td>

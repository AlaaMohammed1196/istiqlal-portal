                ...
                <div class="row">
                    <div class="col-12 col-md-12">
                        <div class="form-floating mb-4">
                            <input type="text" class="form-control" placeholder="" name="GUARANTEE_DESC"/>
                ...
                <div class="row">
                    <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control money-only formattedNumber" placeholder="" name="GUARANTEE_VALUE"/>
            ...
            <form id="edit_warranty" action="{{route('portal.loan-request.warranty.store')}}">
                <div class="modal-body wizard" id="wizardBasic">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" placeholder="" name="GUARANTEE_DESC" id="GUARANTEE_DESC_1"/>
                                <label>وصف الضمان</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-sm-9 col-md-9 col-lg-9">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control money-only formattedNumber" placeholder="" name="GUARANTEE_VALUE" id="GUARANTEE_VALUE_1"/>
                                <label>القيمة التقديرية</label>
                            </div>
                        </div>
                        <div class="col-12 col-sm-3 col-md-3 col-lg-3">
{{--                            <input type="text" name="GURANTEES_CURR_ID" value="{{$constants['DefualtCurr']}}" hidden>--}}
                            <div class="form-floating mb-3 w-100">
                                <select class="select-floating-no-search curr_select" name="GURANTEES_CURR_ID" id="GURANTEES_CURR_ID_1">
                                    <option></option>
                                    @foreach($constants['CURRENCIES'] as $index=>$item)
                                        <option value="{{$item['VALUE']}}">{{$item['LABEL']}}</option>
                                    @endforeach

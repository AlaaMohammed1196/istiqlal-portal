...
<div class="container">
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-lg-12 col-xl-9 col-xxl-8">
            ...
            <div class="card mb-5">
                <div class="card-body">
                    <form id="form_data" action="{{route('portal.profile.update')}}">
                        <div class="mb-3 row">
...
{{--                        <div class="mb-3 row">--}}
{{--                            <p>هذه المعلومات التي سوف يتم استخدامها للتواصل معك مباشرة إما من خلال البريد الإلكتروني أو الرسائل القصيرة على هاتفك الخلوي</p>--}}
{{--                        </div>--}}
                        <div class="mb-3 row">
                    ...
                    <div class="modal-body wizard" id="wizardBasic">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade" id="validationFirst" role="tabpanel">
                                <form class="tooltip-end-bottom" id="update_phone" action="{{route('portal.profile.phone.update')}}">
                                    <div class="alert alert-danger d-none" role="alert"></div>
                                    <div class="row g-0">
                            ...
                            <div class="tab-pane fade" id="validationSecond" role="tabpanel">
                                ...
                                <form class="tooltip-end-bottom" id="verify_code" action="{{route('portal.profile.phone.update')}}">
        ...
        $(document).ready(function() {
            ...
            $('#resend_code').on('click', function (e){
                ...
                $.ajax({
                    headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                    type: "POST",
                    url: '{{route('portal.profile.phone.update')}}',
                    data: {

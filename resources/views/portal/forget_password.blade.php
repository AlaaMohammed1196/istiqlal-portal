                ...
                <div class="wizard" id="wizardValidation">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade" id="validationFirst" role="tabpanel">
                            <p class="card-text text-alternate mb-4 mt-4 fs-6">الرجاء إدخال رقم المشتغل الخاص بحسابك للمتابعة</p>
                            <form class="tooltip-end-bottom" id="phone_form" action="{{route('portal.password.code.request')}}" novalidate="novalidate">
                                ...
                                <input type="text" value="1" required name="SENDING_METHOD_TYPE_ID" id="SENDING_METHOD_TYPE_ID" hidden=""/>
                        ...
                        <div class="tab-pane fade" id="validationSecond" role="tabpanel">
                            <p class="card-text text-alternate mb-4 mt-4 fs-6">تم إرسال رمز تحقق برسالة نصية إلى الهاتف المحمول <span class="text-secondary fw-bold" id="full_number" dir="ltr">00970599013319</span> يرجى إدخال الرمز للتأكيد</p>
            ...
            $('#phone_form').on('submit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status) {
                            $('#full_number').html(response.phone);

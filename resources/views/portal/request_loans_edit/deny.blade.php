            ...
            <section class="scroll-section" id="twoRows">
                        ...
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column justify-content-start">
                                <div class="d-flex flex-column">
                                    <a href="#" class="heading stretched-link"><i class="fa-regular fa-circle-check  text-secondary"></i> تم التسجيل بنجاح</a>
                        ...
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column justify-content-start">
                                <div class="d-flex flex-column text-md-end">
                                    <a href="#" class="heading stretched-link"><i class="fa-regular fa-circle-check text-secondary"></i> تهانينا، لقد تم الموافقة</a>
                                    <div class="text-alternate d-md-none mb-2"></div>
                                    <div class="text-muted">تم مراجعة وتدقيق بيانات الشركة التي قمت بتقديمها أثناء تسجيلك وتم الموافقة عليها.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-0">
                    ...
                    <div class="col-auto sw-7 d-flex flex-column justify-content-center align-items-center position-relative me-4 ms-0 ms-md-4">
                        ...
                        >
                            <div class="bg-gradient-light sw-5 sh-5 rounded-md">
                                <div class="text-white d-flex justify-content-center align-items-center h-100">03</div>
                            </div>
                        </div>
                        <div class="w-100 d-flex h-100 justify-content-center position-relative">
                            <div class="line-w-1 bg-separator h-100 position-absolute"></div>
                    ...
                    <div class="col mb-2">
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column justify-content-start">
                                <div class="d-flex flex-column">
                                    <a href="#" class="heading stretched-link"><i class="fa-solid fa-circle-info fa-x2 "></i> أكمل بيانات الشركة</a>
                                    <div class="text-alternate d-md-none mb-2"></div>
                                    <div class="text-muted">
                                        يجب اكتمال بيانات الشركة الخاصة بك حتى يسمح لك بإستخدام جميع خدماتنا عبر بوابتنا الإلكترونية.
                                    </div>
                                </div>
                            </div>
                        </div>

...
@section('content')
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <h1 class="my-3 pb-0 display-4 text-secondary fw-bold" id="title">تعديل طلب قرض</h1>

                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                        <ul class="breadcrumb pt-0">
                            <li class="breadcrumb-item"><a href="{{route('portal.orders.index')}}">طلباتي</a></li>
                            <li class="breadcrumb-item">تعديل طلب قرض</li>
                        </ul>
                    </nav>
        ...
        <div class="row gx-5">
            <div class="col-md-auto mb-5 d-none d-lg-block col-lg-4 company-data" id="scrollSpyMenu_v2">
                ...
                <div class="card mb-2 table-update-list">
                @include('portal.request_loans_edit.components.list')
                </div>
            </div>
                ...
                <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-0 align-items-start mb-2">
                                    @include('portal.request_loans_edit.components.main_info')
                                </div>
                            </div>
                        </div>
                        <!-- Details End -->
                                    ...
                                    <form>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                @include('portal.request_loans_edit.components.fund_source_table')
                                                </tbody>
                                            </table>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                @include('portal.request_loans_edit.components.fund_source_desc_table')
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <form>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                @include('portal.request_loans_edit.components.warranty_table')
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="col-12 d-flex justify-content-between mb-3 mt-5">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle">
                                                ...
                                                @include('portal.request_loans_edit.components.guarantee_table')
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="mb-3 row mt-5">
                            ...
                            <div class="card-body">
                                <div class="row g-0 align-items-start mb-2">
                                    ...
                                    <div id="balance_table">
                                        @include('portal.request_loans_edit.components.financial_info')
                                    </div>
                                    <div class="mb-3 row mt-3">
                                        ...
                                        <div class="d-sm-flex justify-content-end flex-column flex-sm-row">
                                            ...
                                            <button id="financial_btn" class="btn btn-secondary w-100 w-sm-auto mb-2">التالي</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-income" role="tabpanel" aria-labelledby="pills-income-tab" tabindex="0">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row g-0 align-items-start mb-2">
                                    <div id="income_table">
                                        @include('portal.request_loans_edit.components.financial_income_info')
                                    </div>
                                    <div class="mb-3 row mt-3">
                                        <div class="alert-info p-3 rounded-3 mb-5">في حال عدم وجود قيم لأحد الحقول يجب إدخال قيمة صفر.</div>
                                        <div class="d-sm-flex justify-content-end flex-column flex-sm-row">
                    ...
                    <div class="tab-pane fade" id="pills-attachments" role="tabpanel" aria-labelledby="pills-attachments-tab" tabindex="0">
                        ...
                        <div class="card gallery">
                            <div class="card-body">
                                <div class="row g-0 align-items-start mb-2">
                                    @include('portal.request_loans_edit.components.attachments')
                                </div>
                            </div>
                        </div>
                        <!-- Details End -->
    ...
    @include('portal.request_loans_edit.components.fund_source_modal')
    @include('portal.request_loans_edit.components.fund_source_desc_modal')

    @include('portal.request_loans_edit.components.warranty_modal')
    @include('portal.request_loans_edit.components.guarantee_modal')
@endsection
...
@push('script')
    ...
    <script>
            function updateList(IdName =null)
            {
                $.ajax({
                    dataType: 'html',
                    ...
                    success: function (data) {
                        ...
                        $('.table-update-list').html(data).find('#'+IdName).addClass('active');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status) {
                            ...
                            updateList('pills-warranties-tab');
    ...
    <script>
        let guarantee_list = {!!json_encode($data['FUND_GUARANTEES'])!!};

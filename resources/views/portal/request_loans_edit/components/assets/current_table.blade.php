<div class="table-responsive">
    <table class="table align-middle">
        ...
        @php $cs_sub_sum = 0; $cs_year_sum = 0; @endphp
        ...
        <tr class="table-light">
            ...
            <td class="text-center table-light"><input class="form-control table-input sub text-center" disabled value="{{$cs_sub_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input year text-center" disabled value="{{$cs_year_sum}}"></td>
            <td class="text-center table-light"><input class="form-control table-input diff text-center" disabled value="{{$cs_year_sum-$cs_sub_sum}}"></td>

<form id="attachments_form" action="{{route('portal.loan-request.attachments.store')}}">
        ...
        <div class="col-12 col-lg-6">
            <div class="mb-3">
                <div class="input-group">
                    ...
                    <button class="btn btn-secondary"  type="submit" onclick='window.location.reload();' id="upload_attach">
    ...
    <div id="attach_list">
        @include('portal.request_loans_edit.components.attachments_items')
    </div>

...
{{--                        <input type="text" name="SOURCE_CURR_ID" value="{{$data['Fund_Data'][0]['CURR_ID']}}" hidden>--}}
                        <div class="form-floating mb-3 w-100">
                            <select class="select-floating-no-search curr_select" name="SOURCE_CURR_ID" id="SOURCE_CURR_ID_select">
                                <option></option>
...
{{--                            <input type="text" name="SOURCE_CURR_ID" value="{{$data['Fund_Data'][0]['CURR_ID']}}" hidden>--}}
                            <div class="form-floating mb-3 w-100">
                                <select class="select-floating-no-search curr_select" name="SOURCE_CURR_ID" id="SOURCE_CURR_ID">
                                    <option></option>
                                    @foreach($constants['CURRENCIES'] as $index=>$item)
                                        <option value="{{$item['VALUE']}}" {{$data['Fund_Data'][0]['CURR_ID']==$item['VALUE']?'selected':''}}>{{$item['LABEL']}}</option>
                                    @endforeach

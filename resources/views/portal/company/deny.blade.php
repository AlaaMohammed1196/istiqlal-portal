    ...
    <div class="container">
        ...
        <div class="row gx-5">
            <section class="scroll-section" id="twoRows">
                <div class="row g-0">
                    <div class="col mb-2 justify-content-end align-items-center text-semi-large text-muted d-none d-md-flex">{{$data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE']?\Carbon\Carbon::parse($data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE'])->translatedFormat('d F Y'):''}}</div>
                        ...
                        <div class="card h-100">
                            <div class="card-body d-flex flex-column justify-content-start">
                                <div class="d-flex flex-column">
                                    ...
                                    <div class="text-alternate d-md-none mb-2">{{$data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE']?\Carbon\Carbon::parse($data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE'])->translatedFormat('d F Y'):''}}</div>
                ...
                <div class="row g-0">
                    <div class="col mb-2 justify-content-start align-items-center text-semi-large text-muted d-none d-md-flex order-md-3">{{$data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE']?\Carbon\Carbon::parse($data['CompanyGeneralInfo'][0]['ISTABLISHMENT_DATE'])->translatedFormat('d F Y'):''}}</div>

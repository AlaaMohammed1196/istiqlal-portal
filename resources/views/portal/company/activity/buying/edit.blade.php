    ...
    <div class="container">
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-8 col-xl-8">
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        <form id="policy_update" action="{{route('portal.company.activity.buying.policy.update')}}">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row g-0 align-items-start mb-2">
                                        <div class="mb-4">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control float-only" name="BUY_SELL_PERCENT" value="{{count($policy)>0?$policy[0]['BUY_SELL_PERCENT']:''}}" placeholder="نسبة الشراء %">
                                                <label>نسبة الشراء %</label>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control number-only" name="BUY_SELL_PERIOD" value="{{count($policy)>0?$policy[0]['BUY_SELL_PERIOD']:''}}" placeholder="مدة الآجال / الأيام ">
                                ...
                                <div class="col-12 col-md-12 col-lg-6">
                                    ...
                                    <div class="row g-0 align-items-start mb-2">
                                        <div class="mb-4">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control float-only" name="BUY_SELL_POSTPONED_PERCENT" value="{{count($policy)>0?$policy[0]['BUY_SELL_POSTPONED_PERCENT']:''}}" placeholder="نسبة الشراء %">
                                                <label>نسبة الشراء %</label>
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control number-only" name="BUY_SELL_POSTPONED_PERIOD" value="{{count($policy)>0?$policy[0]['BUY_SELL_POSTPONED_PERIOD']:''}}" placeholder="مدة الآجال / الأيام ">
                                                <label>مدة الآجال / الأيام </label>
                                            </div>
                                        </div>
                                        <div class="form-floating mb-4">

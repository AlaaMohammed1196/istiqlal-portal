...
@section('content')
                ...
                <div class="col-12 col-md-7">
                    ...
                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                        <ul class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('portal.company.activity.selling.index')}}">تفاصيل سياسة البيع</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- Title End -->
        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-8 col-xl-8 position-relative">
                ...
                <div class="d-sm-flex justify-content-end flex-column flex-sm-row">
                    <button  type="button" id="create_policy_btn" class="btn btn-secondary w-100 w-sm-auto mb-2 position-absolute top-m-30"><i class="fa-solid fa-plus"></i> إضافة سياسة بيع</button>
                </div>
                <!-- Details Start -->
                <h2 class="h4">تفاصيل تحليل سياسة البيع</h2>
                <div class="row mb-5">
                                ...
                                <div class="row">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-striped align-middle">
                                            ...
                                            @include('portal.company.activity.selling.policy')
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-xl-12 mt-5 position-relative">
                        <div class="d-sm-flex justify-content-end flex-column flex-sm-row">
                            <button  type="button" data-bs-toggle="modal" data-bs-target="#addnew" class="btn btn-secondary w-100 w-sm-auto mb-2 position-absolute top-m-30"><i class="fa-solid fa-plus"></i> إضافة زبون</button>
                        </div>
                        <!-- Details Start -->
                        <h2 class="h4 mb-3">أكبر خمسة زبائن</h2>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped align-middle">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"  class="text-center">نسبة البيع</th>
                                            <th scope="col"  class="text-center">منطقة البيع</th>
                                        ...
                                        @if(count($data) > 0)
                                            @foreach($data as $index=>$item)
                                                <tr id="item-{{$item['CLIENT_SUPPLIER_ID']}}">
                                                    ...
                                                    <td class="text-center"><span class="">{{$item['SELL_PLACE_DESC']}}</span></td>
    ...
    <div class="modal fade" id="addnew"  data-bs-keyboard="false" role="dialog" aria-labelledby="addnewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addnewLabel">إضافة زبون جديد</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form  id="add_form" action="{{route('portal.company.activity.selling.store')}}">
                    <div class="modal-body wizard" id="wizardBasic">
                        <div class="row g-0 py-2 text-center">
                            <div class="fw-bold h5 mb-2">تفاصيل سياسة البيع</div>
                            <p>ادخل البيانات التالية لإضافة زبون</p>
                        </div>
                        <div class="alert alert-danger mb-4 d-none" role="alert"></div>
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4">
                                    <input type="text" class="form-control" placeholder="اسم الزبون" name="CLIENT_SUPPLIER_NAME" />
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4">
                                    <input type="text" class="form-control float-only" placeholder="نسبة البيع %" name="BUY_SELL_PERCENT" />
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4 w-100">
                                    <select class="select-floating-with-search" name="SELL_PLACE">
                                        <option></option>
                                        @foreach($constants['SaleArea'] as $item)
                                            <option value="{{$item['CONSTANT_ID']}}">{{$item['CONSTANT_DESC']}}</option>
                                        @endforeach
                                    </select>
                                    <label>منطقة البيع</label>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="editModal"  data-bs-keyboard="false" role="dialog" aria-labelledby="addnewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addnewLabel">تعديل بيانات زبون</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form  id="edit_form" action="{{route('portal.company.activity.selling.update')}}">
                    <div class="modal-body wizard" id="wizardBasic">
                        <div class="row g-0 py-2 text-center">
                            <div class="fw-bold h5 mb-2">تفاصيل سياسة البيع</div>
                            <p>ادخل البيانات التالية لتعديل بيانات الزبون</p>
                        </div>
                        <div class="alert alert-danger mb-4 d-none" role="alert"></div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4">
                                    <input type="text" class="form-control" placeholder="اسم الزبون" name="CLIENT_SUPPLIER_NAME" id="CLIENT_SUPPLIER_NAME" />
                                    <label>اسم الزبون</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4">
                                    <input type="text" class="form-control float-only" placeholder="نسبة البيع %" name="BUY_SELL_PERCENT" id="BUY_SELL_PERCENT" />
                                    <label>نسبة البيع %</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 col-md-12">
                                <div class="form-floating mb-4 w-100">
                                    <select class="select-floating-with-search" name="SELL_PLACE" id="SELL_PLACE">
                                        <option></option>
                                        @foreach($constants['SaleArea'] as $item)
                                            <option value="{{$item['CONSTANT_ID']}}">{{$item['CONSTANT_DESC']}}</option>
                                        @endforeach
    ...
    <div class="modal fade" id="addnew_v2"  data-bs-keyboard="false" role="dialog" aria-labelledby="addnewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addnewLabel">إضافة سياسة بيع جديدة</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="add_policy" action="{{route('portal.company.activity.selling.policy.store')}}">
                    <div class="modal-body wizard" id="wizardBasic">
                        <div class="row g-0 py-2 text-center">
                            <div class="fw-bold h5 mb-2">تفاصيل سياسة البيع</div>
                            <p>ادخل البيانات التالية لإضافة سياسة بيع جديدة</p>
                        </div>
                        <div class="alert alert-danger mb-4 d-none" role="alert"></div>
                        <div class="row">
                            <div class="col-12 col-md-12">
    ...
    <div class="modal fade" id="editModal_v2"  data-bs-keyboard="false" role="dialog" aria-labelledby="addnewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addnewLabel">تعديل سياسة بيع</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="edit_policy" action="{{route('portal.company.activity.selling.policy.update')}}">
                    <div class="modal-body wizard" id="wizardBasic">
                        <div class="row g-0 py-2 text-center">
                            <div class="fw-bold h5 mb-2">تفاصيل سياسة البيع</div>
                            <p>ادخل البيانات التالية لتعديل سياسة البيع</p>
                        </div>
                        <div class="alert alert-danger mb-4 d-none" role="alert"></div>
...
@push('script')
    <script>
        ...
        function deletePolicyRecord(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        url: '{{route('portal.company.activity.selling.policy.delete')}}',
                        type: 'POST',
                        data: {
                            id: id,
                        },
        ...
        function editRecord(e){
            ...
            $('#edit_form #CLIENT_SUPPLIER_ID').val(data['CLIENT_SUPPLIER_ID']);
            $('#edit_form #CLIENT_SUPPLIER_NAME').val(data['CLIENT_SUPPLIER_NAME']);
            $('#edit_form #BUY_SELL_PERCENT').val(data['BUY_SELL_PERCENT']);
            $('#edit_form #SELL_PLACE').siblings('.select2').addClass('full');
            $('#edit_form #SELL_PLACE').val(data['SELL_PLACE']).trigger('change');
            $('#edit_form #CLIENT_SUPPLIER_NOTES').val(data['CLIENT_SUPPLIER_NOTES']);
        ...
        function deleteRecord(e){
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                        url: '{{route('portal.company.activity.selling.delete')}}',
                        type: 'POST',
                        data: {
                            id: id,
                        },

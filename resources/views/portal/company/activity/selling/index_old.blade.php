                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="row g-0 bg-light px-3 rounded-lg mb-2 py-2">
                                    <div class="col-12 col-md">
                                        <div class="sh-3 sh-md-5 d-flex align-items-center fw-normal lh-1-25">نسبة البيع</div>
                                    </div>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <div class="row g-0  bg-light px-3 rounded-lg mb-2 py-2">
                                    ...
                                    <div class="col-12">
                                        <p class="lh-lg custom-scroll scroll-200px">{{count($policy)>0?$policy[0]['BUY_SELL_POSTPONED_NOTES']:''}}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        function editRecord(e){
            ...
            $('#SELL_PLACE').siblings('.select2').addClass('full');
            $('#SELL_PLACE').val(data['SELL_PLACE']).trigger('change');

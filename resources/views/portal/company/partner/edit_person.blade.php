                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="wizard p-0" id="wizardValidation_v2">
                                ...
                                <form id="form_data" action="{{route('portal.company.partner.update.person')}}">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade" id="validationFirst" role="tabpanel">
                                            ...
                                            <fieldset class="tooltip-end-bottom step">
                                                <input type="text" name="PARTNER_ID" id="PARTNER_ID" value="{{$data['PARTNER_ID']}}" hidden>
                                                <div class="row mb-4">
                                                    <div class="col-12 col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control" name="FIRST_NAME_NA" id="FIRST_NAME_NA" value="{{$data['FIRST_NAME_NA']}}" placeholder="اسم الشريك">
                                                            <label>اسم الشريك الأول</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control" name="FATHER_NAME_NA" id="FATHER_NAME_NA" value="{{$data['FATHER_NAME_NA']}}" placeholder="اسم الشريك">
                                                            <label>اسم الأب</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control" name="GRAND_FATHER_NAME_NA" id="GRAND_FATHER_NAME_NA" value="{{$data['GRAND_FATHER_NAME_NA']}}" placeholder="اسم الشريك">
                                                            <label>اسم الجد</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3">
                                                        <div class="form-floating mb-3">
                                                            <input type="text" class="form-control" name="FAMILY_NAME_NA" id="FAMILY_NAME_NA" value="{{$data['FAMILY_NAME_NA']}}" placeholder="اسم الشريك">
                                                            <label>اسم العائلة</label>
                                                        </div>
                                                    </div>
                                                </div>
{{--                                                <div class="form-floating mb-4">--}}
{{--                                                    <input type="text" class="form-control" name="PARTNER_FULL_NAME" id="PARTNER_FULL_NAME" value="{{$data['PARTNER_FULL_NAME']}}" placeholder="اسم الشريك رباعي">--}}
...
{{--                                                </div>--}}
                                                <div class="row">
                                                        ...
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" name="ID_TYPE_ID" id="ID_TYPE_ID">
                                                                ...
                                                                @foreach($constants['IndividualIdTypes'] as $item)
                                                                    <option value="{{$item['CONSTANT_ID']}}" {{$item['CONSTANT_ID']==$data['ID_TYPE_ID']?'selected':''}}>{{$item['CONSTANT_DESC']}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="{{$data['ID_TYPE_ID']==1?'number':'text'}}" class="form-control" name="ID_NUM" id="ID_NUM" value="{{$data['ID_NUM']}}" maxlength="9" placeholder="رقم الهوية">
                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating">
                                                            <input type="text" class="form-control" name="BIRTH_PLACE" id="BIRTH_PLACE" value="{{$data['BIRTH_PLACE']}}" placeholder="أدخل مكان الميلاد" />
                                                            <label>مكان الميلاد</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="date-picker-close form-control" name="BIRTH_DATE" id="BIRTH_DATE" value="{{$data['BIRTH_DATE']?\Carbon\Carbon::parse($data['BIRTH_DATE'])->translatedFormat('d-m-Y'):''}}" placeholder="تاريخ الميلاد" autocomplete="off"/>
                                                    ...
                                                    <div class="col-12 col-md-6  mb-4">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-check form-check-inline ">
                                                                <input class="form-check-input" type="radio" name="GENDER_ID" {{$data['GENDER_ID']==1?'checked':''}} id="GENDER_ID_1" value="1">
                                                                <label class="form-check-label" for="GENDER_ID_1">ذكر</label>
                                                            </div>
                                                            <div class="form-check form-check-inline ">
                                                                <input class="form-check-input" type="radio" name="GENDER_ID" {{$data['GENDER_ID']==2?'checked':''}} id="GENDER_ID_2" value="2">
                                                        ...
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" name="MARITAL_STATUS_ID" id="MARITAL_STATUS_ID">
                                                                ...
                                                                @foreach($constants['MaritalStatus'] as $item)
                                                                    <option value="{{$item['CONSTANT_ID']}}" {{$item['CONSTANT_ID']==$data['MARITAL_STATUS_ID']?'selected':''}}>{{$item['CONSTANT_DESC']}}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="row mb-4">
                                                        ...
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" name="NATIONALITY_ID[]" id="NATIONALITY_ID" multiple>
                                                                ...
                                                                @foreach($constants['Nationalities'] as $item)
                                                                    <option value="{{$item['VALUE']}}" {{in_array($item['VALUE'], $data['NATIONALITY_ID'])?'selected':''}}>{{$item['LABEL']}}</option>
                                                                @endforeach
                                                            </select>
                                                            <label>الجنسية</label>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating ">
                                                            <input type="text" class="form-control number-only" name="DEPENDENTS_CNT" id="DEPENDENTS_CNT" value="{{$data['DEPENDENTS_CNT']}}" placeholder="عدد المعالين" />
                                        ...
                                        <div class="tab-pane fade" id="validationSecond" role="tabpanel">
                                            ...
                                            <fieldset class="tooltip-end-bottom step">
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control number-only" name="SHARES_CNT" id="SHARES_CNT" value="{{$data['SHARES_CNT']}}" placeholder="عدد الأسهم">
                                                            <label>عدد الأسهم</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control number-only" name="CONTRIBUTION_PERCENT" id="CONTRIBUTION_PERCENT" value="{{$data['CONTRIBUTION_PERCENT']}}" placeholder="نسبة المساهمة %" />
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-12 col-md-8">
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input" type="radio" name="IS_BANK_BORROWER" {{$data['IS_BANK_BORROWER']==1?'checked':'disabled'}} id="IS_BANK_BORROWER_1" value="1">
                                                            <label class="form-check-label" for="IS_BANK_BORROWER_1">نعم</label>
                                                        </div>
                                                        <div class="form-check form-check-inline ">
                                                            <input class="form-check-input" type="radio" name="IS_BANK_BORROWER" {{$data['IS_BANK_BORROWER']!=1?'checked':'disabled'}} id="IS_BANK_BORROWER_2" value="0">
                                                            <label class="form-check-label" for="IS_BANK_BORROWER_2">لا</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-floating mb-4">
                                                    <textarea class="form-control" name="NOTES" id="NOTES" placeholder="ملاحظات" rows="5" maxlength="{{textMaxSize()}}">{{$data['NOTES']}}</textarea>
                                        ...
                                        <div class="tab-pane fade" id="validationThird" role="tabpanel">
                                            ...
                                            <fieldset class="tooltip-end-bottom step">
                                                <div class="row">
                                                        ...
                                                        <div class="form-floating mb-3 w-100">
                                                            <select class="select-floating-with-search"  name="EDUCATION_LEVEL_ID" id="EDUCATION_LEVEL_ID">
                                                                ...
                                                                @foreach($constants['EducationLevels'] as $item)
                                                                    <option value="{{$item['CONSTANT_ID']}}" {{$item['CONSTANT_ID']==$data['EDUCATION_LEVEL_ID']?'selected':''}}>{{$item['CONSTANT_DESC']}}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control number-only" name="EXPERIENCE_YEARS_CNT" id="EXPERIENCE_YEARS_CNT" value="{{$data['EXPERIENCE_YEARS_CNT']}}" placeholder="سنوات الخبرة للعمل الحالي" />
                                                            <label>سنوات الخبرة للعمل الحالي</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-floating mb-4">
                                                    <textarea class="form-control" name="CURRENT_EXPERIENCE_NOTES" id="CURRENT_EXPERIENCE_NOTES" placeholder="تفاصيل الخبرة للعمل الحالي" rows="5" maxlength="{{textMaxSize()}}">{{$data['CURRENT_EXPERIENCE_NOTES']}}</textarea>
                                                    <label>تفاصيل الخبرة للعمل الحالي</label>
                                                </div>
                                                <div class="form-floating mb-4">
                                                    <textarea class="form-control" name="OTHER_EXPERIENCE_NOTES" id="OTHER_EXPERIENCE_NOTES" placeholder="الخبرة في مجالات أخرى" rows="5" maxlength="{{textMaxSize()}}">{{$data['OTHER_EXPERIENCE_NOTES']}}</textarea>
                                        ...
                                        <div class="tab-pane fade" id="validationFourth" role="tabpanel">
                                            ...
                                            <fieldset class="tooltip-end-bottom step">
                                                <div class="row">
                                                        ...
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" name="COUNTRY_ID" id="COUNTRY_ID">
                                                                ...
                                                                @foreach($countries as $item)
                                                                    <option value="{{$item['COUNTRY_ID']}}" {{$item['COUNTRY_ID']==$data['COUNTRY_ID']?'selected':''}}>{{$item['COUNTRY_NA']}}</option>
                                                                @endforeach
                                                            </select>
                                                            <label>الدولة</label>
                                                        </div>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" {{$data['COUNTRY_ID']?'':'disabled'}} name="STATE_ID" id="STATE_ID">
                                                                <option></option>
                                                                @if($data['COUNTRY_ID'])
                                                                    <?php $states = getStates($data['COUNTRY_ID']) ?>
                                                                    @foreach($states as $item)
                                                                        <option value="{{$item['VALUE']}}" {{$item['VALUE']==$data['STATE_ID']?'selected':''}}>{{$item['LABEL']}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4 w-100">
                                                            <select class="select-floating-with-search" {{$data['STATE_ID']?'':'disabled'}} name="CITY_ID" id="CITY_ID">
                                                                <option></option>
                                                                @if($data['STATE_ID'])
                                                                    <?php $cities = getCities($data['STATE_ID']) ?>
                                                                    @foreach($cities as $item)
                                                                        <option value="{{$item['VALUE']}}" {{$item['VALUE']==$data['CITY_ID']?'selected':''}}>{{$item['LABEL']}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control" name="ADDRESS" id="ADDRESS" placeholder="العنوان" value="{{$data['ADDRESS']}}"/>
                                                            <label>العنوان</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control number-only" name="PHONE_NUMBER" id="PHONE_NUMBER" value="{{$data['PHONE_NUMBER']}}" maxlength="9" placeholder="رقم الهاتف" />
                                                            <label>رقم الهاتف</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control number-only" name="CELULAR_NUMBER" id="CELULAR_NUMBER" value="{{$data['CELULAR_NUMBER']}}" maxlength="10" placeholder="رقم الهاتف المتنقل" />
                                                            <label>رقم الهاتف المتنقل</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-floating mb-4">
                                                            <input type="text" class="form-control" name="EMAIL" id="EMAIL" value="{{$data['EMAIL']}}" placeholder="البريد الإلكتروني" />

                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="row g-0 align-items-start mb-2">
                                <form id="form_data" action="{{route('portal.company.partner.update.firm')}}">
                                    <div class="alert alert-danger mb-4 d-none" role="alert"></div>
                                    <input type="text" name="PARTNER_ID" value="{{$data['PARTNER_ID']}}" hidden>
                                    <div class="mb-4">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" name="PARTNER_FULL_NAME" id="PARTNER_FULL_NAME" value="{{$data['PARTNER_FULL_NAME']}}" placeholder="اسم الشريك">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control number-only" name="ID_NUM" id="ID_NUM" value="{{$data['ID_NUM']}}" placeholder="رقم التسجيل">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-12 col-md-6">
                                            <div class="form-floating">
                                                <input type="text" class="form-control float-only" name="CONTRIBUTION_PERCENT" id="CONTRIBUTION_PERCENT" value="{{$data['CONTRIBUTION_PERCENT']}}" placeholder="نسبة المساهمة">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="col-12">
                                                <div class="form-check form-check-inline ">
                                                    <input class="form-check-input" type="radio" name="IS_BANK_BORROWER" id="IS_BANK_BORROWER_1" {{$data['IS_BANK_BORROWER']==1?'checked':'disabled'}} value="1">
                                                    <label class="form-check-label" for="IS_BANK_BORROWER_1">نعم</label>
                                                </div>
                                                <div class="form-check form-check-inline ">
                                                    <input class="form-check-input" type="radio" name="IS_BANK_BORROWER" id="IS_BANK_BORROWER_0" {{$data['IS_BANK_BORROWER']!=1?'checked':'disabled'}} value="0">
                                    ...
                                    <div class="form-floating mb-4">
                                        <textarea class="form-control" name="COMPANY_NOTES" id="COMPANY_NOTES" placeholder="ملاحظات حول الشركة التابعة" rows="5" maxlength="{{textMaxSize()}}">{{$data['COMPANY_NOTES']}}</textarea>

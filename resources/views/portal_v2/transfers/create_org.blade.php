                ...
                <div class="card-body">
                    <form id="form_data" action="{{route('portal.v2.transfers.submit')}}">
                        ...
                        <div class="mb-3 row align-items-center d-none">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">إلى حساب</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_ID" id="BENEFICIARY_ID-out" data-placeholder="إلى حساب" data-width="100%" disabled>
                                    <option></option>
                        ...
                        <div class="mb-3 row align-items-center d-none">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">إلى حساب</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_ID" id="BENEFICIARY_ID-in" data-placeholder="إلى حساب" data-width="100%" disabled>
                                    <option></option>
                        ...
                        <div class="mb-3 row align-items-center d-none">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="INCLUDE_COMMISSION" checked id="INCLUDE_COMMISSION_1" value="1" disabled>
                                    <label class="form-check-label" for="INCLUDE_COMMISSION_1">نعم</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="INCLUDE_COMMISSION" id="INCLUDE_COMMISSION_2" value="2" disabled>
                        ...
                        <div class="mb-3 row align-items-center d-none">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="file" class="form-control" id="ATTACHMENTS" name="ATTACHMENTS[]" onchange="loadFile(this)" hidden= />

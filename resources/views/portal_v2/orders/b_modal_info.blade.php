<input type="text" name="BENEFICIARY_SEQ" value="{{$extra['BENEFICIARY_SEQ']}}" hidden>
...
<div class="table-responsive">
    <table id="checkboxTable" class="table align-middle">
        <thead>
        <tr>
            <th scope="col" style="word-wrap: break-word;">الصلاحية</th>
                ...
                <td class="text-center">
                    ...
                    @endif
                        @if($role['USER_HAVE_ROLE'] && $role['APPROVAL_STATUS_ID']!=1)
                            <a href="javascript:void(0);" role="button" data-type="1" data-seq="{{$extra['BENEFICIARY_SEQ']}}" data-step="{{$item['STEP_ID']}}" data-role="{{$role['ROLE_ID']}}" class="undo_step_request btn btn-sm btn-icon btn-icon-only btn-outline-danger align-top mx-1"

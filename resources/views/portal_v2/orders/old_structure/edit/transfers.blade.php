                ...
                <div class="card-body">
                    <form id="form_data" action="{{route('portal.v2.transfers.submit')}}">
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                ...
                                <select class="select-single-with-search CUST_LEDGER_ID" name="CUST_LEDGER_ID" id="CUST_LEDGER_ID" data-placeholder="من حساب" data-width="100%">
                                    <option></option>
                                    @foreach($constants['CustomerAccounts'] as $item)
                                        <option value="{{$item['LEDGER_ID']}}" {{$data['FROM_LEDGER_ID']==$item['LEDGER_ID']?'selected':''}} data-BRANCH_ID="{{$item['BRANCH_ID']}}" data-ACC_NUM="{{$item['ACC_NUM']}}" data-CURR_ID="{{$item['CURR_ID']}}" data-ACC_SUB_NUM="{{$item['ACC_SUB_NUM']}}" data-CURR_NAME="{{$item['CURR_NAME']}}">{{$item['ACCOUNT_NUM']}}, {{$item['LEDGER_NAME_NA']}}, {{$item['ACCOUNT_BALANCE']}} {{$item['CURR_NAME']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control formattedNumber" value="{{$data['BEN'][0]['AMOUNT']}}" name="AMOUNT" id="AMOUNT" placeholder="المبلغ"/>
                            </div>
                        </div>
                        @endif
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_ID" id="BENEFICIARY_ID-out" data-placeholder="إلى حساب" data-width="100%">
                                    ...
                                    @foreach($external_beneficiaries as $item)
                                        <option value="{{$item['BENEFICIARY_ID']}}">{{$item['BANK_NAME']}} - {{$item['BANK_BRANCH_NAME']}} - {{$item['IBAN']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>

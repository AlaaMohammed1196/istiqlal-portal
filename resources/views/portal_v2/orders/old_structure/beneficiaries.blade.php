                ...
                <tr class="beneficiary_order" id="order1-{{$item['BENEFICIARY_SEQ']}}">
                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <a href="javascript:void(0);" role="button" data-answer="1" data-type="1" data-seq="{{$item['BENEFICIARY_SEQ']}}" data-status="{{$item['APPROVAL_STATUS_ID']}}" class="request_details btn btn-sm btn-icon btn-icon-only btn-outline-secondary align-top mx-1"
                               data-bs-toggle="tooltip" data-bs-title="عرض التفاصيل">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            @if($item['IS_UPDATABLE'] == 1)
                                <a href="{{route('portal.v2.orders.beneficiaries.edit', $item['BENEFICIARY_SEQ'])}}" class="btn btn-sm btn-icon btn-icon-only btn-outline-dark align-top ms-2"
                                   data-bs-toggle="tooltip" data-bs-title="تعديل">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                            @endif
                            @if($item['APPROVAL_STATUS_ID'] != 1)
                            <a href="javascript:void(0);" role="button" data-answer="-1" data-type="1" data-seq="{{$item['BENEFICIARY_SEQ']}}" data-id="" class="step_request btn btn-sm btn-icon btn-icon-only btn-outline-secondary align-top mx-1"
                               data-bs-toggle="tooltip" data-bs-title="عرض خطوات الطلب">
                                <i class="fa-solid fa-list"></i>
                            </a>
                            @endif
                            @if($item['APPROVAL_STATUS_ID'] == 1)
                                <a href="javascript:void(0);" role="button" data-answer="1" data-type="1" data-seq="{{$item['BENEFICIARY_SEQ']}}" data-id="" class="step_request btn btn-sm btn-icon btn-icon-only btn-outline-success align-top mx-1"
                                   data-bs-toggle="tooltip" data-bs-title="الموافقة على الطلب">
                                    <i class="fa-solid fa-circle-check"></i>
                                </a>
                            @endif
                            @if($item['APPROVAL_STATUS_ID'] == 1)
                            <button href="javascript:void(0);" role="button" data-answer="0" data-type="1" data-seq="{{$item['BENEFICIARY_SEQ']}}" data-id="" class="step_request btn btn-sm btn-icon btn-icon-only btn-outline-danger align-top mx-1"
                                    data-bs-toggle="tooltip" data-bs-title="رفض الطلب">
                                <i class="fa-solid fa-ban"></i>
                            </button>
                            @endif
                            @if($item['APPROVAL_STATUS_ID'] == 1 && $item['IS_CANCELABLE'] == 1)
                                <a href="javascript:void(0);" role="button" data-answer="4" data-type="1" data-seq="{{$item['BENEFICIARY_SEQ']}}" data-id="" class="reject_request btn btn-sm btn-icon btn-icon-only btn-outline-danger align-top mx-1"

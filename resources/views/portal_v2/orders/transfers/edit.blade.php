        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <h1 class="my-3 pb-0 display-4 text-secondary fw-bold" id="title">تعديل طلب حوالة</h1>
                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                        <ul class="breadcrumb pt-0">
                            <li class="breadcrumb-item"><a href="{{route('portal.v2.home')}}">الرئيسية</a></li>
                            <li class="breadcrumb-item"><a href="{{route('portal.v2.orders.index').'?tab=transfers'}}">طلبات الحوالات</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">تعديل طلب حوالة</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- Title End -->
                ...
                <div class="card-body">
                    <form id="form_data" action="{{route('portal.v2.transfers.submit')}}">
                        <div class="row g-0 py-2 text-center">
                            <div class="sh-3 sh-md-5 fw-bold lh-1-25 h5"><i class="fa-solid fa-right-left ms-2"></i> تعديل طلب حوالة</div>
                        </div>
                        <div class="alert alert-danger mb-4 d-none" role="alert"></div>
                        <input type="text" name="transfer_type" value="{{$data['PAY_TYPE_ID']}}" hidden="">
                        <input type="text" name="VOUCHER_SEQ" value="{{$data['VOUCHER_SEQ']}}" hidden="">
                        <input type="text" name="VOUCHER_NO" value="{{$data['VOUCHER_NO']}}" hidden="">
                        @if($data['PAY_TYPE_ID'] == 10)
                        <div class="mb-3 row align-items-center">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">من حساب</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="FROM_LEDGER_ID" value="{{$data['FROM_BRANCH_ID']}}" id="FROM_BRANCH_ID" name="FROM_BRANCH_ID" hidden>
                                <input type="text" class="FROM_LEDGER_ID" value="{{$data['FROM_CURR_ID']}}" id="FROM_CURR_ID" name="FROM_CURR_ID" hidden>
                                <input type="text" class="FROM_LEDGER_ID" value="{{$data['FROM_ACC_NUM']}}" id="FROM_ACC_NUM" name="FROM_ACC_NUM" hidden>
                                <input type="text" class="FROM_LEDGER_ID" value="{{$data['FROM_ACC_SUB_NUM']}}" id="FROM_ACC_SUB_NUM" name="FROM_ACC_SUB_NUM" hidden>
                                <select class="select-single-with-search FROM_LEDGER_ID" name="FROM_LEDGER_ID" id="FROM_LEDGER_ID" data-placeholder="من حساب" data-width="100%">
                                    ...
                                    @foreach($constants['CustomerAccounts'] as $item)
                                        <option value="{{$item['LEDGER_ID']}}" {{$data['FROM_ACCOUNT_NUM']==$item['ACCOUNT_NUM']?'selected':''}} data-BRANCH_ID="{{$item['BRANCH_ID']}}" data-ACC_NUM="{{$item['ACC_NUM']}}" data-CURR_ID="{{$item['CURR_ID']}}" data-ACC_SUB_NUM="{{$item['ACC_SUB_NUM']}}" data-CURR_NAME="{{$item['CURR_NAME']}}">{{$item['ACCOUNT_NUM']}}, {{$item['LEDGER_NAME_NA']}}, {{$item['ACCOUNT_BALANCE']}} {{$item['CURR_NAME']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="TO_LEDGER_ID" value="{{$data['BEN'][0]['TO_BRANCH_ID']}}" id="TO_BRANCH_ID" name="TO_BRANCH_ID" hidden>
                                <input type="text" class="TO_LEDGER_ID" value="{{$data['BEN'][0]['TO_CURR_ID']}}" id="TO_CURR_ID" name="TO_CURR_ID" hidden>
                                <input type="text" class="TO_LEDGER_ID" value="{{$data['BEN'][0]['TO_ACC_NUM']}}" id="TO_ACC_NUM" name="TO_ACC_NUM" hidden>
                                <input type="text" class="TO_LEDGER_ID" value="{{$data['BEN'][0]['TO_ACC_SUB_NUM']}}" id="TO_ACC_SUB_NUM" name="TO_ACC_SUB_NUM" hidden>
                                <select class="select-single-with-search TO_LEDGER_ID" name="TO_LEDGER_ID" id="TO_LEDGER_ID" data-placeholder="إلى حساب" data-width="100%">
                                    <option></option>
                                    @foreach($constants['CustomerAccounts'] as $item)
                                        <option value="{{$item['LEDGER_ID']}}" {{$data['BEN'][0]['TO_ACCOUNT_NUM']==$item['ACCOUNT_NUM']?'selected':''}} data-BRANCH_ID="{{$item['BRANCH_ID']}}" data-ACC_NUM="{{$item['ACC_NUM']}}" data-CURR_ID="{{$item['CURR_ID']}}" data-ACC_SUB_NUM="{{$item['ACC_SUB_NUM']}}" data-CURR_NAME="{{$item['CURR_NAME']}}">{{$item['ACCOUNT_NUM']}}, {{$item['LEDGER_NAME_NA']}}, {{$item['ACCOUNT_BALANCE']}} {{$item['CURR_NAME']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row align-items-center">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">من حساب</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="CUST_LEDGER_ID" value="{{$data['FROM_BRANCH_ID']}}" id="CUST_BRANCH_ID" name="CUST_BRANCH_ID" hidden>
                                <input type="text" class="CUST_LEDGER_ID" value="{{$data['FROM_CURR_ID']}}" id="CUST_CURR_ID" name="CUST_CURR_ID" hidden>
                                <input type="text" class="CUST_LEDGER_ID" value="{{$data['FROM_ACC_NUM']}}" id="CUST_ACC_NUM" name="CUST_ACC_NUM" hidden>
                                <input type="text" class="CUST_LEDGER_ID" value="{{$data['FROM_ACC_SUB_NUM']}}" id="CUST_ACC_SUB_NUM" name="CUST_ACC_SUB_NUM" hidden>
                                <select class="select-single-with-search CUST_LEDGER_ID" name="CUST_LEDGER_ID" id="CUST_LEDGER_ID" data-placeholder="من حساب" data-width="100%">
                                    <option></option>
                                    @foreach($constants['CustomerAccounts'] as $item)
                                        <option value="{{$item['LEDGER_ID']}}" {{$data['FROM_ACCOUNT_NUM']==$item['ACCOUNT_NUM']?'selected':''}} data-BRANCH_ID="{{$item['BRANCH_ID']}}" data-ACC_NUM="{{$item['ACC_NUM']}}" data-CURR_ID="{{$item['CURR_ID']}}" data-ACC_SUB_NUM="{{$item['ACC_SUB_NUM']}}" data-CURR_NAME="{{$item['CURR_NAME']}}">{{$item['ACCOUNT_NUM']}}, {{$item['LEDGER_NAME_NA']}}, {{$item['ACCOUNT_BALANCE']}} {{$item['CURR_NAME']}}</option>
                                    @endforeach
                        ...
                        <div class="mb-3 row internal_beneficiaries_inputs">
                            <div class="col-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                        ...
                                        @foreach($data['BEN'] as $index=>$ben)
                                            <tr id="internal-{{$index+1}}">
                                                <td>
                                                    <div><strong>{{$ben['TO_ACCOUNT_NAME']}}</strong></div>
                                                    <div><strong>{{$ben['TO_LEDGER_NAME']}} - {{$ben['TO_CURR_NAME']}}</strong></div>
                                                    <div><strong>{{$ben['TO_ACCOUNT_NUM']}}</strong></div>
                                                    <input type="text" hidden class="BENEFICIARY_ID" name="BENEFICIARY_ID[]" value="{{$ben['BENEFICIARY_ID']}}">
                                                </td>
                                                <td class="text-center">
                                                    {{NumberFormat($ben['AMOUNT'], $data['CURR_DECIMAL_PLACES'])}}
                                                    <input type="text" hidden class="AMOUNT" name="AMOUNT[]" value="{{$ben['AMOUNT']}}">
                                                </td>
                                                <td class="text-center">
                                                    {{$ben['REMITTANCE_PURPOSE_NA']}}
                                                    <input type="text" hidden class="REMITTANCE_PURPOSE_ID" name="REMITTANCE_PURPOSE_ID[]" value="{{$ben['REMITTANCE_PURPOSE_ID']}}">
                                                </td>
                                                <td class="text-center">
                        ...
                        <div class="mb-3 row external_beneficiaries_inputs">
                            <div class="col-12">
                                <div class="col-12 d-flex justify-content-between mb-3">
                                    <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">المستفيدين</label>
                                    ...
                                    <table class="table align-middle">
                                        ...
                                        @foreach($data['BEN'] as $index=>$ben)
                                            <tr id="external-{{$index+1}}">
                                                ...
                                                <td class="text-center">
                                                    {{NumberFormat($ben['TO_AMOUNT_ACC'], $ben['TO_CURR_DECIMAL_PLACES'])}} {{$ben['TO_CURR_NAME']}}
                                                    <input type="text" hidden class="AMOUNT" name="AMOUNT[]" value="{{$ben['AMOUNT']}}">
                                                </td>
                                                <td class="text-center">
                                                    {{$ben['REMITTANCE_PURPOSE_NA']}}
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control formattedNumber" value="{{$data['FROM_AMOUNT_ACC']}}" name="AMOUNT" id="AMOUNT" placeholder="المبلغ"/>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search currency" id="CURR_ID" name="CURR_ID" data-placeholder="عملة الحوالة" data-width="100%">
                                    <option value=""></option>
                                    @if($data['PAY_TYPE_ID'] == 7)
                        ...
                        @if($data['PAY_TYPE_ID'] == 7)
                        <div class="mb-3 row align-items-center {{count($data['BEN'])>1?'d-none':''}}">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">شامل العمولة</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="INCLUDE_COMMISSION" {{$data['INCLUDE_COMMISSION']==1?'checked':''}} id="INCLUDE_COMMISSION_1" value="1" {{count($data['BEN'])>1?'disabled':''}}>
                                    <label class="form-check-label" for="INCLUDE_COMMISSION_1">نعم</label>
                                </div>
                                <div class="form-check form-check-inline ">
                                    <input class="form-check-input" type="radio" name="INCLUDE_COMMISSION" {{$data['INCLUDE_COMMISSION']!=1?'checked':''}} id="INCLUDE_COMMISSION_2" value="2" {{count($data['BEN'])>1?'disabled':''}}>
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="REMITTANCE_PURPOSE_ID" id="REMITTANCE_PURPOSE_ID" data-placeholder="الغرض من الحوالة" data-width="100%">
                                    ...
                                    @foreach($constants['RemittancePurposes'] as  $item)
                                        <option value="{{$item['REMITTANCE_PURPOSE_ID']}}" {{$data['BEN'][0]['REMITTANCE_PURPOSE_ID']==$item['REMITTANCE_PURPOSE_ID']?'selected':''}}>{{$item['REMITTANCE_PURPOSE_NA']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control" placeholder="ملاحظات" value="{{$data['NOTES']}}" name="NOTES" id="NOTES" />
                            </div>
                        </div>
                        @endif
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_ID" id="BENEFICIARY_ID-in" data-placeholder="إلى حساب" data-width="100%">
                                    ...
                                    @foreach($internal_beneficiaries as $item)
                                        <option value="{{$item['BENEFICIARY_ID']}}" data-ACCOUNT_NAME="{{$item['ACCOUNT_NAME']}}" data-LEDGER_NAME="{{$item['BENEFICIARY_LEDGER_NAME']}}" data-ACCOUNT_NUM="{{$item['ACCOUNT_NUM']}}" data-CURR_ID="{{$item['BENEFICIARY_CURR_ID']}}" data-CURR_NAME="{{$item['BENEFICIARY_CURR_NAME']}}">{{$item['BENEFICIARY_FULL_NAME']}} - {{$item['BANK_ACCOUNT_NUMBER']}} - {{$item['BENEFICIARY_CURR_NAME']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_ID" id="BENEFICIARY_ID-out" data-placeholder="إلى حساب" data-width="100%">
                                    ...
                                    @foreach($external_beneficiaries as $item)
                                        <option value="{{$item['BENEFICIARY_ID']}}" data-BANK_NAME="{{$item['BANK_NAME']}}" data-BANK_BRANCH_NAME="{{$item['BANK_BRANCH_NAME']}}" data-IBAN="{{$item['IBAN']}}">{{$item['BANK_NAME']}} - {{$item['BANK_BRANCH_NAME']}} - {{$item['IBAN']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@push('script')
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#CURR_ID option[value="'+CURR_ID+'"]').attr('selected', true);
        })
        ...
        $(document).on('submit', '#addNewInternalForm', function (e) {
            ...
            let ACCOUNT_NAME = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-ACCOUNT_NAME');
            let BENEFICIARY_LEDGER_NAME = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-LEDGER_NAME');
            let CURR_NAME = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-CURR_NAME');
            let ACCOUNT_NUM = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-ACCOUNT_NUM');
            ...
            if(BENEFICIARY_ID_value && AMOUNT_value && REMITTANCE_PURPOSE_ID_value){
                ...
                let row = '<td>' +
                    ...
                    '<div><strong>' + BENEFICIARY_LEDGER_NAME + ' - ' + CURR_NAME + '</strong></div>' +
                    '<div><strong>' + ACCOUNT_NUM + '</strong></div>' +
        ...
        $(document).on('submit', '#addNewExternalForm', function (e) {
            ...
            let BENEFICIARY_ID_value = form.find('[name="BENEFICIARY_ID"]').val();
            let BENEFICIARY_ID_text = form.find('[name="BENEFICIARY_ID"] option:selected').text();
            let BANK_NAME = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-BANK_NAME');
            let BANK_BRANCH_NAME = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-BANK_BRANCH_NAME');
            let IBAN = form.find('[name="BENEFICIARY_ID"] option:selected').attr('data-IBAN');
            let AMOUNT_value = form.find('[name="AMOUNT"]').val();
            let AMOUNT_text = form.find('[name="AMOUNT"]').siblings('.input-number').val();
            let REMITTANCE_PURPOSE_ID_value = form.find('[name="REMITTANCE_PURPOSE_ID"]').val();
            let REMITTANCE_PURPOSE_ID_text = form.find('[name="REMITTANCE_PURPOSE_ID"] option:selected').text();
            ...
            if(BENEFICIARY_ID_value && AMOUNT_value && REMITTANCE_PURPOSE_ID_value){
                let count = table.find('tr').length;
                let row = '<td>' +
                    '<div><strong>'+BANK_NAME+' - '+BANK_BRANCH_NAME+'</strong></div>' +

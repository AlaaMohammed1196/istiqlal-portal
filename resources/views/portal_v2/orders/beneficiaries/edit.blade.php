        ...
        <div class="page-title-container">
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <h1 class="my-3 pb-0 display-4 text-secondary fw-bold" id="title">تعديل طلب مستفيد</h1>

                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                        <ul class="breadcrumb pt-0">
                            <li class="breadcrumb-item"><a href="{{route('portal.v2.home')}}">الرئيسية</a></li>
                            <li class="breadcrumb-item"><a href="{{route('portal.v2.orders.index')}}">طلبات المستفيدين</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">تعديل طلب مستفيد</a></li>
                        </ul>
                    </nav>
            ...
            <div class="card col-md-8 mb-3 mt-5">
                <form id="add_new" action="{{route('portal.v2.beneficiaries.submit')}}">
                    <div class="card-body">
                        ...
                        <input type="text" name="BENEFICIARY_SEQ" value="{{$data['BENEFICIARY_SEQ']}}" hidden="">
                        <input type="text" name="BENEFICIARY_ID" value="{{$data['BENEFICIARY_ID']}}" hidden="">

            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-6 col-xxl-6">
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <div class="mb-5">
                            <div class="row g-0 mx-auto align-items-center mb-2">
                                <div class="col-auto">
                                ...
                                <div class="col pe-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">نوع الوثيقة</div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="sh-5 d-flex fw-bold align-items-center">{{$data['ID_TYPE_DESC']??'-'}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-0 mx-auto align-items-center mb-2">
                                ...
                                <div class="col pe-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">رقم الوثيقة</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 mx-auto align-items-center mb-2">
                                ...
                                <div class="col pe-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">العمل</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="row g-0 mx-auto align-items-center mb-2">
                                <div class="col-auto">
                                    <div class="border border-secondary sw-5 sh-5 rounded-xl d-flex justify-content-center align-items-center">
                                        <i class="fa-solid fa-comment-sms text-secondary"></i>
                                    </div>
                                </div>
                                <div class="col pe-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">الرسائل القصيرة</div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="sh-5 d-flex fw-bold align-items-center">{{$data['SMS_RECEIVE_FLAG']==1?'فعالة':'غير فعالة'}}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-5">
                            <p class="text-secondary fw-bold mb-2">الصلاحيات</p>
                            <div class="row g-0 align-items-center mb-2">
                                <div class="col-auto">
                                    <div class="border border-secondary sw-5 sh-5 rounded-xl d-flex justify-content-center align-items-center">
                                ...
                                <div class="col pe-3">
                                    <div class="row g-0">
                                        <div class="col">
                                            <div class="sh-5 d-flex align-items-center lh-1-25">الصلاحيات</div>
                                        </div>
                                        <div class="col-auto">
                                            <div class="sh-5 d-flex fw-bold align-items-center">
                                                @foreach($data['USER_ROLES'] as $index=>$item)
                                                    <span>{{$index!=0?', ':''}}{{$item['ROLE_DESC']}}</span>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="addnew"  data-bs-keyboard="false" role="dialog" aria-labelledby="addnewLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="change_password" action="{{route('portal.v2.profile.password.change')}}">

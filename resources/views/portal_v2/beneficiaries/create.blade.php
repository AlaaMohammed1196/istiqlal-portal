                ...
                <div class="col-12 col-md-7">
                    ...
                    <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                        <ul class="breadcrumb pt-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0);">إضافة مستفيد جديد</a></li>
                        </ul>
                    </nav>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control" name="BENEFICIARY_FULL_NAME" id="BENEFICIARY_FULL_NAME" placeholder="اسم المستفيد" />
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                        ...
                        <div class="mb-3 row align-items-center d-none">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">اسم البنك</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control" name="BANK_NAME" id="BANK_NAME" disabled placeholder="اسم البنك" />
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center d-none">
                            <label class="col-lg-3 col-md-3 col-sm-4 col-form-label">اسم فرع البنك</label>
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control" name="BANK_BRANCH_NAME" id="BANK_BRANCH_NAME" disabled placeholder="اسم فرع البنك" />
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center d-none">
                        ...
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control number-only" name="BANK_ACCOUNT_NUMBER" id="BANK_ACCOUNT_NUMBER" placeholder="حساب المستفيد" value="" />
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center d-none">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <select class="select-single-with-search" name="BENEFICIARY_LEDGER_ID" id="BENEFICIARY_LEDGER_ID" data-placeholder="نوع الحساب" data-width="100%">
                                    ...
                                    @foreach($ledgers as $item)
                                        <option value="{{$item['LEDGER_ID']}}">{{$item['LEDGER_NAME_NA']}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
                            ...
                            <div class="col-sm-8 col-md-9 col-lg-9">
                                <input type="text" class="form-control number-only" name="BENEFICIARY_ACC_SUB_NUM" id="BENEFICIARY_ACC_SUB_NUM" placeholder="رقم الحساب الفرعي" />
                            </div>
                        </div>
                        <div class="mb-3 row align-items-center">
    ...
    <script>
        $(document).on('change', 'input[name="BANK_LOCATION"]', function (e) {
            ...
            if(value == 2) {
                ...
                form.find('#IBAN').parents().siblings('label').html('رقم الحساب الدولي');
                form.find('#IBAN').attr('placeholder', 'رقم الحساب الدولي');
            }else if(value == 1){
                ...
                form.find('#BENEFICIARY_ACC_SUB_NUM').parents('.row').addClass('d-none');
                form.find('#BENEFICIARY_ACC_SUB_NUM').attr('disabled', 'true');
                form.find('#IBAN').parents().siblings('label').html('IBAN');
                form.find('#IBAN').attr('placeholder', 'IBAN');
            }else{
                form.find('#BANK_ID').parents('.row').addClass('d-none');
                form.find('#BANK_ID').attr('disabled', 'true');
                form.find('#BANK_BRANCH_ID').parents('.row').addClass('d-none');
